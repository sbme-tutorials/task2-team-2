...
kidneyT1 =np.full((5,5  ), 255) 
liverT1=np.full((3,3), 255)
spleenT1=np.full((6,6), 255)
fatT1=np.full((7,7), 255)
...
T2=np.full((32,32 ), 0)  
kidneyT2 =np.full((5,5  ), 128) 
liverT2=np.full((3,3), 128)
spleenT2=np.full((6,6), 128)
fatT2=np.full((7,7), 128)
