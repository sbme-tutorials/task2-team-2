...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.kspace_label.setFrameShape(QtWidgets.QFrame.Panel)
        self.kspace_label.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.kspace_label2 = QtWidgets.QLabel(self.widget1)
        self.kspace_label2.setFrameShape(QtWidgets.QFrame.Panel)
        self.kspace_label2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.kspace_label2.setText("")
        self.kspace_label2.setScaledContents(True)
        self.kspace_label2.setObjectName("kspace_label2")
        self.verticalLayout_6.addWidget(self.kspace_label2)
        ...
        self.inverseFourier_label = QtWidgets.QLabel(self.widget1)
        self.inverseFourier_label.setFrameShape(QtWidgets.QFrame.Panel)
        self.inverseFourier_label.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.inverseFourier_label2 = QtWidgets.QLabel(self.widget1)
        self.inverseFourier_label2.setFrameShape(QtWidgets.QFrame.Panel)
        self.inverseFourier_label2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.inverseFourier_label2.setText("")
        self.inverseFourier_label2.setScaledContents(True)
        self.inverseFourier_label2.setObjectName("inverseFourier_label2")
        self.verticalLayout_5.addWidget(self.inverseFourier_label2)
        self.gridLayout_5.addWidget(self.splitter_6, 0, 0, 1, 5)
        ...
        self.gridLayout_5.addWidget(self.convert_button, 1, 4, 1, 1)
        self.generate_button = QtWidgets.QPushButton(self.tab_2)
        self.generate_button.setObjectName("generate_button")
        self.gridLayout_5.addWidget(self.generate_button, 1, 3, 1, 1)
        ...
        self.splitter_7 = QtWidgets.QSplitter(self.tab_4)
        self.splitter_7.setOrientation(QtCore.Qt.Horizontal)
        self.splitter_7.setObjectName("splitter_7")
        self.widget3 = QtWidgets.QWidget(self.splitter_7)
        ...
        self.widget4 = QtWidgets.QWidget(self.splitter_7)
        ...
        self.widget5 = QtWidgets.QWidget(self.splitter_7)
        ...
        self.gridLayout_8.addWidget(self.splitter_7, 0, 0, 1, 2)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(832, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(2, _translate("MainWindow", "64x64"))
        self.comboBox.setItemText(3, _translate("MainWindow", "128x128"))
        self.comboBox.setItemText(4, _translate("MainWindow", "256x256"))
        self.comboBox.setItemText(5, _translate("MainWindow", "512x512"))
        ...
        self.label_20.setText(_translate("MainWindow", "Phantom"))
        ...
        self.comboBox_4.setItemText(1, _translate("MainWindow", "Artifact #1"))
        self.comboBox_4.setItemText(2, _translate("MainWindow", "Artifact #2"))
